...
<body class="tutorial-body">
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <img src="img/bag.jpg" alt="Bags to store specimens" class="img-fluid tutorial-custom-img rounded shadow">
            <h6 class="tutorial-img-heading">Bags to store specimens</h6>
        </div>
        <div class="col-md-4">
            <img src="img/shovel.jpg" alt="Trowel for digging up roots" class="img-fluid tutorial-custom-img rounded shadow">
            <h6 class="tutorial-img-heading">Trowel for digging up roots</h6>
        </div>
        <div class="col-md-4">
            <img src="img/clipper.jpg" alt="Clipper for cutting woody stems" class="img-fluid tutorial-custom-img rounded shadow">
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <img src="img/straps.jpg" alt="Straps and cupboards for pressing and drying" class="img-fluid tutorial-custom-img rounded shadow">
            <h6 class="tutorial-img-heading">Straps and cupboards for pressing and drying</h6>
        </div>
        <div class="col-md-4">
            <img src="img/waxPaper.webp" alt="Wax paper for mounting plants" class="img-fluid tutorial-custom-img rounded shadow">
            <h6 class="tutorial-img-heading">Wax paper for mounting plants</h6>
        </div>
        <div class="col-md-4">
            <img src="img/mountingpaper.webp" alt="Mounting paper for displaying specimens" class="img-fluid tutorial-custom-img rounded shadow">
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <img src="img/tweezers.jpeg" alt="Tweezers for handling specimens" class="img-fluid tutorial-custom-img rounded shadow">
            <h6 class="tutorial-img-heading">Tweezers for handling specimens</h6>
        </div>
        <div class="col-md-4">
            <img src="img/plantpress.jpg" alt="Plant press for pressing specimens" class="img-fluid tutorial-custom-img rounded shadow">
            <h6 class="tutorial-img-heading">Plant press for pressing specimens</h6>
        </div>
        <div class="col-md-4">
            <img src="img/brush.png" alt="Small brush for applying adhesive" class="img-fluid tutorial-custom-img rounded shadow">
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <img src="img/lens.jpg" alt="Hand lens for examination" class="img-fluid tutorial-custom-img rounded shadow">
